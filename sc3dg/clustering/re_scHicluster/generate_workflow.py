...
template_path = '/cluster2/home/Kangwen/0_benchmark/1_method/re_scHicluster/template.JSON'

reslutions_list = ['50k', '500k']


result_path = '/cluster2/home/Kangwen/0_benchmark/2_result/2_schicluster'
...
for res in reslutions_list:
    for dr_base,filelist,info in zip(outdir_base, filelist_path_list,info_list ):
        ...
        config['res'] =  intres
        config['filelist'] = os.path.join(outdir, 'filelist.txt')
...
# 创建slurm脚本
code = '/cluster2/home/Kangwen/0_benchmark/3_workflow/schicluster.sh'
python_code = '/cluster2/home/Kangwen/0_benchmark/1_method/re_scHicluster/0_schicluster_pipeline.py'




slurm_script = '''#!/bin/bash
#SBATCH -J schicluster
